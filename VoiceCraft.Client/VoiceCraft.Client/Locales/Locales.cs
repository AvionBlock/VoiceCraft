...
public static class Locales
{
    ...
    public static string Settings_General_General => Localizer.Get("Settings.General.General");
    ...
    public static string Settings_Audio_Audio => Localizer.Get("Settings.Audio.Audio");
    ...
    public static string Settings_Audio_MicrophoneTest_MicrophoneTest => Localizer.Get("Settings.Audio.MicrophoneTest.MicrophoneTest");
    ...
    public static string Settings_Advanced_Advanced => Localizer.Get("Settings.Advanced.Advanced");
