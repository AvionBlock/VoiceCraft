...
public class AudioService
{
    ...
    private class EmptyRegisteredAudioPreprocessor()
        : RegisteredAudioPreprocessor(Guid.Empty, "Common.None", () => throw new NotSupportedException(), true, true,
            true);

    private class EmptyRegisteredAudioClipper()
        : RegisteredAudioClipper(Guid.Empty, "Common.None", () => throw new NotSupportedException());
}
