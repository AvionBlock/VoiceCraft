...
`VoiceCraft.Client.Windows.<Architecture>.zip`.
...
Go to where you have downloaded the `VoiceCraft.Client.Windows.<Architecture>.zip` file in your file manager and extract
the file. Once extracted, navigate into the extracted folder and open the `VoiceCraft.Client.Windows.exe` executable.