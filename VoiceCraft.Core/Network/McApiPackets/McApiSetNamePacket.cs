...
{
    public class McApiSetNamePacket : McApiPacket
    {
        public McApiSetNamePacket(string sessionToken = "", int id = 0, string value = "")
        {
        ...
        public override McApiPacketType PacketType => McApiPacketType.SetName;
