...
namespace VoiceCraft.Core.Network.McApiPackets.Request
{
    ...
    {
        public McApiSetEntityTitleRequestPacket() : this(string.Empty, 0, string.Empty)
        {
        }
        
        public McApiSetEntityTitleRequestPacket(string token, int id, string value)
        {
            Token = token;
            Id = id;
            Value = value;
        ...
        public McApiSetEntityTitleRequestPacket Set(string token = "", int id = 0, string value = "")
        {
            Token = token;
            Id = id;
            Value = value;
