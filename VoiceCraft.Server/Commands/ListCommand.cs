...
namespace VoiceCraft.Server.Commands
{
    public class ListCommand : Command
    {
        ...
        {
            var clientsOnlyOption = new Option<bool>("--" + Locales.Locales.Commands_List_Options_clientsOnly_Name, () => false, Locales.Locales.Commands_List_Options_clientsOnly_Name);
            var limitOption = new Option<int>("--" + Locales.Locales.Commands_List_Options_limit_Name, () => 10, Locales.Locales.Commands_List_Options_limit_Description);
