...
public class SetPropertyCommand : Command
{
    public SetPropertyCommand(VoiceCraftServer server) : base(Locales.Locales.Commands_SetProperty_Name, Locales.Locales.Commands_SetProperty_Description)
    {
        ...
        var keyArgument = new Argument<PropertyKey>(Locales.Locales.Commands_SetProperty_Options_key_Name,
            Locales.Locales.Commands_SetProperty_Options_key_Description);
        var valueArgument = new Argument<int?>(Locales.Locales.Commands_SetProperty_Options_value_Name,
            Locales.Locales.Commands_SetProperty_Options_value_Description);
