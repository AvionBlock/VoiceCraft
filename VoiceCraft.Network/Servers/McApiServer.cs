    ...
    protected void ExecutePacket(IMcApiPacket packet, McApiNetPeer netPeer)
    {
        switch (packet)
        {
            ...
            case McApiSetEntityCaveFactorRequestPacket setEntityCaveFactorRequestPacket:
                HandleSetEntityCaveFactorRequestPacket(setEntityCaveFactorRequestPacket, netPeer);
                break;
            case McApiSetEntityMuffleFactorRequestPacket setEntityMuffleFactorRequestPacket:
                HandleSetEntityMuffleFactorRequestPacket(setEntityMuffleFactorRequestPacket, netPeer);
                break;
        }
    }
