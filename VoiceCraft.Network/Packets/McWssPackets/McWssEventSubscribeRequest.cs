...
namespace VoiceCraft.Network.Packets.McWssPackets
{
    ...
    [JsonSerializable(typeof(McWssEventSubscribeRequest), GenerationMode = JsonSourceGenerationMode.Metadata)]
    public partial class McWssEventSubscribeRequestGenerationContext : JsonSerializerContext;
}