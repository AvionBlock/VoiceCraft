...
public class McApiOnEntityCaveFactorUpdatedPacket(int id, float value) : IMcApiEventPacket
{
    ...
    public McApiEventType EventType => McApiEventType.OnEntityCaveFactorUpdated;
