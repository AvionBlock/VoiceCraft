...
public class McApiOnEntityAudioDataReceivedPacket(int id, ushort timestamp, float loudness, int length, byte[] buffer)
    : IMcApiEventPacket
{
    public McApiOnEntityAudioDataReceivedPacket() : this(0, 0, 0.0f, 0, [])
    {
    }
